  ...
  const steps = [
    {
      ...
      desc: "We dive deep into your business logic to understand your pain points and goals.",
      icon: <MessageSquare size={24} />,
    },
    {
      number: "02",
      title: "Planning & UI/UX",
      desc: "Architecting the blueprint and crafting intuitive interfaces designed for users.",
      icon: <PenTool size={24} />,
    },
    {
      number: "03",
      title: "Development & Testing",
      desc: "Writing clean, scalable code followed by rigorous automated and manual testing.",
      icon: <Code2 size={24} />,
    },
    {
      number: "04",
      title: "Deployment & Support",
      desc: "Launching your solution to the world and providing ongoing technical maintenance.",
      icon: <Rocket size={24} />,
    },
  ];
      ...
      <div className="mx-auto px-6 lg:px-16">
        ...
        <div className="flex flex-col mb-20">
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-[#31b8c6] text-xs font-black uppercase tracking-[0.4em]">Workflow</span>
          </div>
          <h2 className="text-4xl md:text-5xl font-black tracking-tighter text-slate-900">
            OUR PROVEN <span className="text-[#31b8c6]">PROCESS.</span>
          </h2>
        </div>
        ...
        <div className="relative">
          ...
          {/* IMPROVED LINE: Aligned to icons, better color and visibility */}
          <div className="hidden lg:block absolute top-10 left-[10%] right-[10%] h-[2px] bg-slate-100 z-0">
             {/* Progress Fill (Optional Decorative Effect) */}
            ...
            {steps.map((step, index) => (
              <div key={index} className="group flex flex-col items-center lg:items-start">
                ...
                <div className="relative mb-8">
                  {/* We added 'relative z-10' and bg-white to ensure the circle hides the line behind it */}

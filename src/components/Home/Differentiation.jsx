...
const Differentiation = () => {
 const secondaryPoints = [
  ...
  return (
    <section className="w-full bg-[#111111] py-24 px-0 sm:px-6 md:px-12 lg:px-24 lg:py-32 overflow-hidden relative">
      {/* Subtle red dotted texture */}
      <div className="absolute inset-0 opacity-[0.07]" style={{ backgroundImage: 'radial-gradient(#DC2626 1px, transparent 1px)', backgroundSize: '32px 32px' }}></div>
      {/* Soft red glow */}
      <div className="absolute -top-40 left-1/2 -translate-x-1/2 w-[700px] h-[700px] bg-[#DC2626]/15 blur-[140px] rounded-full pointer-events-none"></div>
      ...
      <div className="w-full px-6 lg:px-16 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-7 bg-white/5 border border-white/10 rounded-[3rem] p-10 lg:p-14 text-white flex flex-col justify-between group shadow-2xl">
            <div>
          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
            ...
            {/* Speed Card */}
            <div className="bg-white/5 border border-white/10 rounded-[2.5rem] p-8 flex items-center justify-between group hover:translate-y-[-5px] transition-transform duration-300 shadow-xl">
              <div className="max-w-[70%]">
                <h3 className="text-2xl font-black text-white mb-2">Faster Launches</h3>
                <p className="text-slate-400 text-sm font-medium">Get your software live quicker with our proven development approach.</p>
              </div>
            ...
            {/* List of points Card */}
            <div className="bg-white/5 border border-white/10 backdrop-blur-md rounded-[2.5rem] p-8 space-y-8 shadow-xl">
        ...
        <div className="mt-20 flex flex-col md:flex-row items-center justify-center gap-6">
           ...
           <Link to="/contact" className="px-10 py-5 bg-[#DC2626] text-white rounded-2xl font-black uppercase text-xs tracking-[0.2em] shadow-lg shadow-[#DC2626]/20 hover:bg-[#b91c1c] transition-all flex items-center gap-3 group">
